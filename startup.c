/*reference the symbols as unsigned char
NOTE: These are NOT variables, we gonna get the address using the &*/
extern unsigned char __stack_init;
extern unsigned char __bss_start;
extern unsigned char __bss_end;
extern unsigned char __data_init;
...
/*The following array should be place at the first FLASH memory adress*/
